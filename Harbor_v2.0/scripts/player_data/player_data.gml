enum PP { 
	MAX_LIFE, LIFE, CONTROL, TYPE, AFFINITY, SKIN, CURRENCY,
	LEFT_KEY, RIGHT_KEY, UP_KEY, DOWN_KEY, A1_KEY, A2_KEY, A3_KEY,
}

#region Player 1 Data
...
global.playerData[PLAYER.P2, PP.CONTROL]	= CONTROL.CPU;
global.playerData[PLAYER.P2, PP.TYPE]		= CHARACTER_TYPE.ANIMAL;
global.playerData[PLAYER.P2, PP.AFFINITY]	= [ELEMENT.WATER, ELEMENT.GRASS];
